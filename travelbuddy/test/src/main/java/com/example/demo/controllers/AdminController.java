...
public class AdminController {
	...
	{
		return new ResponseDTO<>(HttpStatus.OK, "Fetching user list successfully", as.fetchAllUsers());
	}
	@DeleteMapping("/delete/{propId}")
	 public ResponseDTO<?> deleteById(@PathVariable int propId)
	 {
		  try {
			 return new ResponseDTO<>(HttpStatus.OK,"Property removed succssfully",as.deletePropertyById(propId));
